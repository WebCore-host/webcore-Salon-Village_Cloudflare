          ...
          <div className="hidden md:flex items-center">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`transition-premium font-nav relative py-2 ml-10 ${
                  isActive(link.path) 
            ...
            <div className="h-6 w-[1px] bg-gold/30 mx-2 ml-10"></div>
            <span
              className="text-gold font-bold hover:text-gold-bright transition-colors cursor-default font-nav text-sm tracking-wider text-glow-gold-soft ml-12"
            >
              (346) 439-6712
            </span>
            <a 
              ...
              className="text-gold hover:text-gold-bright transition-premium flex items-center justify-center p-1 ml-10"
            ...
            <a 
              href="https://www.facebook.com/share/1Aw7Qee6ya/?mibextid=wwXIfr" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gold hover:text-gold-bright transition-premium flex items-center justify-center p-1 ml-8"
              aria-label="Facebook"
            >
              <svg className="w-8 h-8 fill-current drop-shadow-md" viewBox="0 0 24 24">
      ...
      >
        <div className="px-6 pt-6 pb-8 space-y-6 relative">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="absolute bottom-8 right-20 text-gold hover:text-white transition-premium p-2 bg-gold/5 border border-gold/20 rounded-lg shadow-gold-nav"
            aria-label="Instagram"
          >
